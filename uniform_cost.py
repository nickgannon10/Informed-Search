import numpy as np
#identical to A* but cost total cost function is modified
class node:
    ...
    #heuristic in uniformed search is used for goal testing 
...
U_C = Uniform_Cost([9,8,7,6,5,4,3,1,2,10])
U_C.constraints()
U_C.execute()
U_C.show_solution()
